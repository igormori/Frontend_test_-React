...
class ProgressOne extends Component {
  state = {
    newLine:""
  }
  ...
  render() {
    ...
    <div className="container mt-5">
      <div className="row mb-3 text-left">
        <div className="col">
          <span className="steps mr-2">1</span>{this.state.newLine}
          <b className="textActive">Add address</b>
        </div>
        <div className="col">
        ...
        <div className="col">
          <span className="steps2 mr-2">3</span>{this.state.newLine}
      ...
      <div className="col bg-white progressBar "  progressBar>
      
      </div>
      <div className="col bg-white progressBar " >
